...
var Shiitake = function (_React$Component) {
  ...
  function Shiitake(props) {
    ...
    var allChildren = typeof props.children === 'string' ? props.children : '';
    var children = props.renderFullOnServer ? allChildren : '';
  ...
  _createClass(Shiitake, [{
    ...
    value: function componentWillReceiveProps(newProps) {
      ...
      if (children !== this.state.allChildren) {
        var allChildren = typeof children === 'string' ? children : '';
        this.setState({ lastCalculatedWidth: -1, children: children, allChildren: allChildren });
        ...
        this._callDeffered(function () {
          _this2.setState({ testChildren: '', lastCalculatedWidth: -1, children: _this2.state.allChildren });
          _this2.handleResize();
        });
      }
    }
    ...
    value: function _checkHeight(start, end) {
      ...
      var linear = end - start < 6 || end === this.state.testChildren.length && end !== this.state.allChildren.length || this.state.lastCalculatedWidth > -1;
    ...
    value: function _setChildren() {
      var children = this.state.allChildren;
    ...
    value: function render() {
      ...
      var overflow = testChildren.length < this.state.allChildren.length ? overflowNode : null;
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { ref: function ref(node) {
              ...
              }, style: _constants.spreaderStyles, 'aria-hidden': 'true' },
            this.state.allChildren
          ),
          _react2.default.createElement(
            'span',
            { style: _constants.sizerWrapperStyles, 'aria-hidden': 'true' },
            _react2.default.createElement(
              'span',
              { ref: function ref(node) {
                  _this4.sizer = node;
