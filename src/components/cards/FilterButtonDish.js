...
class FilterButtonDish extends React.Component {
    ...
    render() {
      ...
      let containerActual = {}
      let textActual = {}
      if (this.props.dishesSelected === true) {
...
import { selectTypeDishes } from './actions/buttons'
...
const mapDispatchToProps = {
  onPress: selectTypeDishes, /* selectSignUp, */
  handleCardFiltering: requestCardFiltering,
}

export const FilterButtonDishContainer = connect(
  mapStateToProps,
  mapDispatchToProps,
)(FilterButtonDish)
export default FilterButtonDishContainer
