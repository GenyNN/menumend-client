...
class FilterButtonAllTypes extends React.Component {
    ...
    componentDidMount() {
      if (this.props.allTypesSelected) {
    ...
    render() {
      ...
      let containerActual = {}
      let textActual = {}
      if (this.props.allTypesSelected === true) {
...
import { selectAllTypes } from './actions/buttons'
...
const mapDispatchToProps = {
  onPress: selectAllTypes, /* selectSignUp, */
  handleCardFiltering: requestCardFiltering,
}

export const FilterButtonAllTypesContainer = connect(
  mapStateToProps,
  mapDispatchToProps,
)(FilterButtonAllTypes)
export default FilterButtonAllTypesContainer
