        ...
        >
          <View style={styles.shareModalWrapper}>
            ...
            <View style={styles.servicesWrapper}>
              {services.map((item, index, array) => <View key={item} onClick={() => functions[index](this.props.url)} style={styles.oneServiceWrapper}><Image style={styles.serviceImage} resizeMode="contain" source={images[index]} /><Text style={styles.serviceTitle} >{item}</Text></View>)}
              <View onClick={() => this.props.copyLink(this.props.url)} style={styles.oneServiceWrapper}><Image style={styles.serviceImage} resizeMode="contain" source={CopyLinkPic} /><CopyToClipboard text={this.props.url}><Text style={styles.serviceTitle}>{this.props.linkCopied ? 'Link copied' : 'Copy Link'}</Text></CopyToClipboard></View>
            </View>
          </View>
        </Modal>
    )
