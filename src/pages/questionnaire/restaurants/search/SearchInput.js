...
class SearchInput extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    const prevCity = prevProps.currentCity ? prevProps.currentCity.city : ''

    if (this.props.currentCity && prevCity !== this.props.currentCity.city) {
      this.input.setValue(this.props.currentCity.city)
    }
  }
...
const mapStateToProps = (state) => ({
  currentCity: state.restaurants.currentCity
})
